 ...
 * until the page has rendered two views for PRIME_FRAMES frames, views.ts appends its inert
 * 'right' view. A session that stays mono is a true single view after that.
 */
